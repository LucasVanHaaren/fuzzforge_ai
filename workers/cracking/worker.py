"""
FuzzForge Vertical Worker: Hash Cracking

This worker:
1. Discovers workflows for the 'cracking' vertical from mounted toolbox
...
async def main():
    ...
    vertical = os.getenv("WORKER_VERTICAL", "cracking")
